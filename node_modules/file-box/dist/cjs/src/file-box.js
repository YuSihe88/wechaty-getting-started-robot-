...
const chunker_transform_stream_js_1 = require("./pure-functions/chunker-transform-stream.js");
...
class FileBox {
    ...
    static fromDataURL(dataUrl, name) {
        return this.fromBase64((0, misc_js_1.dataUrlToBase64)(dataUrl), name);
    }
    /**
     *
    ...
    async ready() {
        if (this.boxType === file_box_type_js_1.FileBoxType.Url) {
    ...
    async syncRemoteName() {
        ...
        const filename = (0, misc_js_1.httpHeaderToFileName)(headers);
        if (filename) {
            this.name = filename;
        }
        if (!this.name) {
    ...
    toString() {
        return [
            'FileBox#',
            file_box_type_js_1.FileBoxType[this.boxType],
            '<',
            this.name,
            '>',
        ].join('');
    ...
    toJSON() {
        ...
        switch (this.boxType) {
            case file_box_type_js_1.FileBoxType.Url: {
                ...
                const objUrl = {
                    boxType: file_box_type_js_1.FileBoxType.Url,
            ...
            case file_box_type_js_1.FileBoxType.QRCode: {
                ...
                const objQRCode = {
                    boxType: file_box_type_js_1.FileBoxType.QRCode,
                    qrCode: this.qrCode,
                };
                obj = {
                    ...objCommon,
            ...
            case file_box_type_js_1.FileBoxType.Base64: {
                ...
                const objBase64 = {
                    base64: this.base64,
                    boxType: file_box_type_js_1.FileBoxType.Base64,
                };
                obj = {
                    ...objCommon,
                    ...objBase64,
    ...
    async toStream() {
        ...
        switch (this.boxType) {
            ...
            case file_box_type_js_1.FileBoxType.Base64:
                ...
                break;
            default:
                throw new Error('not supported FileBoxType: ' + file_box_type_js_1.FileBoxType[this.boxType]);
        }
        return stream;
    }
    /**
    ...
    transformBufferToStream(buffer) {
         ...
         */
        return bufferStream.pipe((0, chunker_transform_stream_js_1.chunkerTransformStream)());
    }
    ...
    async toBase64() {
        if (this.boxType === file_box_type_js_1.FileBoxType.Base64) {
            if (!this.base64) {
                throw new Error('no base64 data');
            }
            return this.base64;
    ...
    async toBuffer() {
        if (this.boxType === file_box_type_js_1.FileBoxType.Buffer) {
            if (!this.buffer) {
                throw new Error('no buffer!');
            }
            return this.buffer;
    ...
    async toQRCode() {
        if (this.boxType === file_box_type_js_1.FileBoxType.QRCode) {
            if (!this.qrCode) {
                throw new Error('no QR Code!');
            }
            return this.qrCode;
