...
(0, tstest_1.test)('File smoke testing', async (t) => {
    const box = file_box_js_1.FileBox.fromFile('x');
    t.ok(box);
});
...
(0, tstest_1.test)('syncRemote()', async (t) => {
    class FileBoxTest extends file_box_js_1.FileBox {
        ...
        syncRemote() { return super.syncRemote(); }
    }
...
(0, tstest_1.test)('fromUuid()', async (t) => {
    ...
    FileBoxTest.setUuidResolver((_) => Promise.resolve(stream));
...
(0, tstest_1.test)('setUuidLoader()', async (t) => {
    ...
    t.doesNotThrow(() => FileBoxTest1.setUuidResolver((_) => ({})), 'should not throw for set loader for the first time');
    t.throws(() => FileBoxTest1.setUuidResolver((_) => ({})), 'should throw for set loader twice');
    t.doesNotThrow(() => FileBoxTest2.setUuidResolver((_) => ({})), 'should not throw for set loader for the first time');
    t.throws(() => FileBoxTest2.setUuidResolver((_) => ({})), 'should throw for set loader twice');
});
(0, tstest_1.test)('setUuidSaver()', async (t) => {
    ...
    t.doesNotThrow(() => FileBoxTest1.setUuidRegister((_) => Promise.resolve('uuid')), 'should not throw for set loader for the first time');
    t.throws(() => FileBoxTest1.setUuidRegister((_) => Promise.resolve('uuid')), 'should throw for set loader twice');
    t.doesNotThrow(() => FileBoxTest2.setUuidRegister((_) => Promise.resolve('uuid')), 'should not throw for set loader for the first time');
    t.throws(() => FileBoxTest2.setUuidRegister((_) => Promise.resolve('uuid')), 'should throw for set loader twice');
});
