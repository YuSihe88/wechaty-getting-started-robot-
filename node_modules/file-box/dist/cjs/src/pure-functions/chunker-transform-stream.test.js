...
const chunker_transform_stream_js_1 = require("./chunker-transform-stream.js");
(0, tstest_1.test)('chunkerTransformStream()', async (t) => {
    ...
    const newStream1 = createStream().pipe((0, chunker_transform_stream_js_1.chunkerTransformStream)(2));
    ...
    const newStream2 = createStream().pipe((0, chunker_transform_stream_js_1.chunkerTransformStream)(1));
