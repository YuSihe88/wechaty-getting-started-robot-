        ...
        try {
            for (var _f = __asyncValues(storeFixture()), _g; _g = yield _f.next(), !_g.done;) {
                ...
                try {
                    ...
                    for (var store_1 = (e_3 = void 0, __asyncValues(store)), store_1_1; store_1_1 = yield store_1.next(), !store_1_1.done;) {
    ...
    t.test('async iterator', (t) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            for (var _k = __asyncValues(storeFixture()), _l; _l = yield _k.next(), !_l.done;) {
                ...
                let n = 0;
                try {
                    for (var store_2 = (e_5 = void 0, __asyncValues(store)), store_2_1; store_2_1 = yield store_2.next(), !store_2_1.done;) {
...
blue_tape_1.default('async keys()', (t) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        for (var _8 = __asyncValues(storeFixture()), _9; _9 = yield _8.next(), !_9.done;) {
            ...
            let count = 0;
            try {
                for (var _10 = (e_13 = void 0, __asyncValues(store.keys())), _11; _11 = yield _10.next(), !_11.done;) {
                    const _ = _11.value;
                    count++;
                }
            }
            ...
            yield store.set(KEY, VAL);
            try {
                for (var _12 = (e_14 = void 0, __asyncValues(store.keys())), _13; _13 = yield _12.next(), !_13.done;) {
                    const key = _13.value;
...
blue_tape_1.default('async values()', (t) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        for (var _17 = __asyncValues(storeFixture()), _18; _18 = yield _17.next(), !_18.done;) {
            ...
            let count = 0;
            try {
                for (var _19 = (e_16 = void 0, __asyncValues(store.values())), _20; _20 = yield _19.next(), !_20.done;) {
                    const _ = _20.value;
                    count++;
                }
            }
            ...
            yield store.set(KEY, VAL);
            try {
                for (var _21 = (e_17 = void 0, __asyncValues(store.values())), _22; _22 = yield _21.next(), !_22.done;) {
    ...
    try {
        for (var _32 = __asyncValues(storeFixture()), _33; _33 = yield _32.next(), !_33.done;) {
            ...
            try {
                ...
                yield store.set('b', 5);
                try {
                    for (var _34 = (e_21 = void 0, __asyncValues(store.values({ gte: 4 }))), _35; _35 = yield _34.next(), !_35.done;) {
                ...
                try {
                    for (var _36 = (e_22 = void 0, __asyncValues(store.values({ lte: 4 }))), _37; _37 = yield _36.next(), !_37.done;) {
