...
class Request extends PadLocalClientPlugin_1.PadLocalClientPlugin {
    ...
    __sendMessage(payload, seq, ack) {
        ...
        brolog_1.log.silly(LOGPRE, `[tid:${this.traceId}] send event to server, seq:${seq}, ack:${ack}, type: ${actionMessage.getPayloadCase()}, payload: ${Utils_1.stringifyPB(payload, ByteUtils_1.MAX_LOG_BYTES_LEN)}`);
    ...
    _onServerMessage(serverMessage) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            brolog_1.log.silly(LOGPRE, `[tid:${this.traceId}] receive event from server, seq:${seq} ack:${ack}, type:${serverMessage.getPayloadCase()}, payload:${Utils_1.stringifyPB(payload, ByteUtils_1.MAX_LOG_BYTES_LEN)}`);
