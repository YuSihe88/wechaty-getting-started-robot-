...
class WeChatHttpProxy {
    ...
    send() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                brolog_1.log.silly(LOGPRE, `[tid:${this.traceId}] http #${this.retryStrategy.retryCount} retry request, after delay: ${delay}ms, [${this.request.getMethod()}]${this.request.getUrl()}`);
    ...
    _sendImpl() {
        return __awaiter(this, void 0, void 0, function* () {
            brolog_1.log.silly(LOGPRE, `[tid:${this.traceId}] http send, [${this.request.getMethod()}]${this.request.getUrl()}`);
            return new Promise((resolve, reject) => {
                ...
                const req = protocol.request(this.request.getUrl(), {
                    ...
                    res.on("end", () => {
                        brolog_1.log.silly(LOGPRE, `[tid:${this.traceId}] http receive, response: ${ByteUtils_1.bytesToHexString(responseDataBuffer, ByteUtils_1.MAX_LOG_BYTES_LEN)}`);
