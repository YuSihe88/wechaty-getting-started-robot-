...
class WeChatLongLinkProxy extends events_1.EventEmitter {
    ...
    sendStreamData(data, streamCallback) {
        ...
        this.logDebug(`socket send:${ByteUtils_1.bytesToHexString(data, ByteUtils_1.MAX_LOG_BYTES_LEN)}`);
    ...
    sendRequest(longLinkRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                this.logDebug(`socket send:${ByteUtils_1.bytesToHexString(buffer, ByteUtils_1.MAX_LOG_BYTES_LEN)}`);
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!this._socketPromise) {
                this._socketPromise = new Promise((resolve, reject) => {
                    ...
                    socket.on("data", (data) => {
                        this.logDebug(`socket recv:${ByteUtils_1.bytesToHexString(data, ByteUtils_1.MAX_LOG_BYTES_LEN)}`);
                        // stream mode
                    ...
                    socket.on("close", () => {
                        this._serialExecutor.execute(() => __awaiter(this, void 0, void 0, function* () {
                            yield this._onSocketError(new IOError("longlink socket is closed"));
                        }));
                    });
                    socket.on("timeout", () => {
                        this._serialExecutor.execute(() => __awaiter(this, void 0, void 0, function* () {
                            yield this._onSocketError(new IOError("longlink socket is read-write timeout"));
                        }));
                    });
                    socket.on("error", (error) => {
                        this._serialExecutor.execute(() => __awaiter(this, void 0, void 0, function* () {
                            yield this._onSocketError(error);
                        }));
                    });
                });
            }
    ...
    logDebug(...args) {
        brolog_1.log.silly(`[LongLink] [${this._id}]`, ...args);
    }
}
