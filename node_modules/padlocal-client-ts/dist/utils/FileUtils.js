...
function downloadFile(fileDownloadRequest, traceId) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        brolog_1.log.silly(LOGPRE, `[tid:${traceId}] send file request, host:\"${fileDownloadRequest
            .getHost()
        ...
        brolog_1.log.silly(LOGPRE, `[tid:${traceId}] [${downloadCostTime}ms] received response: ${retCode}, encrypted file len: ${fileData ? fileData.length : "null"}`);
        const ret = fileUnpacker.getDecryptedFileData(response);
        const decryptCostTime = new Date().getTime() - socketEndDate.getTime();
        brolog_1.log.silly(LOGPRE, `[tid:${traceId}] [${decryptCostTime}ms] decrypted file data len: ${ret.length}`);
        return ret;
    });
}
