...
tstest_1.default('jqFile query boolean', (t) => __awaiter(void 0, void 0, void 0, function* () {
...
tstest_1.default('jqFile query string with options = { raw: true }', (t) => __awaiter(void 0, void 0, void 0, function* () {
    const JSON_FILE = path_1.default.join(__dirname, '../tests/fixtures/test.json');
...
tstest_1.default('jqFile query string', (t) => __awaiter(void 0, void 0, void 0, function* () {
    const JSON_FILE = path_1.default.join(__dirname, '../tests/fixtures/test.json');
    const FILTER = '.version';
    const EXPECTED_OUTPUT = '"1.0.0"';
    const output = yield node_jq_1.jqFile(FILTER, JSON_FILE);
...
tstest_1.default('jqJson', (t) => __awaiter(void 0, void 0, void 0, function* () {
    const JSON_OBJ = {
        json: 42,
    };
    const FILTER = '.json';
...
tstest_1.default('jqString', (t) => __awaiter(void 0, void 0, void 0, function* () {
