...
async function main() {
    ...
    server.addService(mod_js_1.puppet.PuppetService, puppetServerExample);
    const serverBindPromise = util_1.default.promisify(server.bindAsync.bind(server));
    const port = await serverBindPromise('127.0.0.1:8788', mod_js_1.grpc.ServerCredentials.createInsecure());
