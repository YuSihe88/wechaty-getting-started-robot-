...
const wechaty_mocker_1 = require("wechaty-mocker");
const ding_dong_1 = require("./ding-dong");
tstest_1.default('isMatchConfig {mention: true}', async (t) => {
    for await (const fixture of wechaty_mocker_1.createFixture()) {
        const CONFIG = {
            mention: true,
            room: true,
        };
...
tstest_1.default('isMatchConfig {mention: false}', async (t) => {
    for await (const fixture of wechaty_mocker_1.createFixture()) {
        const CONFIG = {
            mention: false,
            room: true,
...
tstest_1.default('isMatchConfig {room: true}', async (t) => {
    for await (const fixture of wechaty_mocker_1.createFixture()) {
        const CONFIG = {
            contact: false,
            ding: /.*/,
        ...
        let result = await isMatch(roomMessage);
...
tstest_1.default('isMatchConfig {room: false}', async (t) => {
    for await (const fixture of wechaty_mocker_1.createFixture()) {
        const CONFIG = {
            ding: /.*/,
            room: false,
...
tstest_1.default('isMatchConfig {dm: true}', async (t) => {
    for await (const fixture of wechaty_mocker_1.createFixture()) {
        const CONFIG = {
            contact: true,
            ding: /.*/,
...
tstest_1.default('isMatchConfig {dm: false}', async (t) => {
    for await (const fixture of wechaty_mocker_1.createFixture()) {
        const CONFIG = {
            contact: false,
            ding: /.*/,
...
tstest_1.default('isMatchConfig {self: false}', async (t) => {
    for await (const fixture of wechaty_mocker_1.createFixture()) {
        const CONFIG = {
            ding: /.*/,
            self: false,
        ...
        const room = fixture.wechaty.wechaty.Room.load(fixture.mocker.room.id);
        const bot = fixture.wechaty.wechaty.userSelf();
        const selfMessage = await new Promise(resolve => {
            room.once('message', resolve);
            fixture.mocker.bot.say().to(fixture.mocker.room);
        });
        const notSelfMessage = await new Promise(resolve => {
            bot.once('message', resolve);
            fixture.mocker.player.say().to(fixture.mocker.bot);
        });
...
tstest_1.default('isMatchConfig {self: true}', async (t) => {
    for await (const fixture of wechaty_mocker_1.createFixture()) {
        const CONFIG = {
            ding: /.*/,
            self: true,
...
tstest_1.default('isMatchConfig {room: /ChatOps/}', async (t) => {
    for await (const fixture of wechaty_mocker_1.createFixture()) {
        const CONFIG = {
            mention: false,
            room: /ChatOps/i,
        ...
        const chatopsMessage = await new Promise(resolve => {
        ...
        const otherMessage = await new Promise(resolve => {
