...
tstest_1.default('detectLanguage()', async (t) => {
...
tstest_1.default('includeLanguage()', async (t) => {
...
tstest_1.default('languageMatcher()', async (t) => {
    const CHINESE_TEXT = '你好';
    const ENGLISH_TEXT = 'hello';
...
tstest_1.default('languageMatcher() with array options', async (t) => {
    const CHINESE_TEXT = '你好';
    const ENGLISH_TEXT = 'hello';
