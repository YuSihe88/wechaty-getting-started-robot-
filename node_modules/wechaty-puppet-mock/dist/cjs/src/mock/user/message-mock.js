...
exports.mockerifyMessageMock = exports.MessageMock = void 0;
...
class MessageMock {
    constructor(payload) {
        ...
        wechaty_puppet_1.log.silly('MockMessage', 'constructor(%s)', JSON.stringify(payload));
    }
    ...
    static get pool() {
        if (!this[POOL]) {
            wechaty_puppet_1.log.verbose('MockMessage', 'get pool() init pool');
            this[POOL] = new Map();
        }
        if (this === MessageMock) {
            throw new Error('The global MockMessage class can not be used directly!'
    ...
    static create(payload) {
        wechaty_puppet_1.log.verbose('MockMessage', 'static create(%s)', JSON.stringify(payload));
        ...
        const newMessage = new this(payload);
    ...
    talker() {
        wechaty_puppet_1.log.verbose('MockMessage', 'talker()');
    ...
    room() {
        wechaty_puppet_1.log.verbose('MockMessage', 'room()');
    ...
    listener() {
        wechaty_puppet_1.log.verbose('MockMessage', 'listener()');
    ...
    text() {
        wechaty_puppet_1.log.verbose('MockMessage', 'text()');
        return this.payload.text;
    }
    type() {
        wechaty_puppet_1.log.silly('MockMessage', 'text()');
        return this.payload.type;
    }
    async toContact() {
        wechaty_puppet_1.log.verbose('MockMessage', 'toContact()');
        if (this.type() !== wechaty_puppet_1.MessageType.Contact) {
    ...
    // }
    async toFileBox() {
        wechaty_puppet_1.log.verbose('MockMessage', 'toFileBox()');
        if (this.type() === wechaty_puppet_1.MessageType.Text) {
...
function mockerifyMessageMock(mocker) {
...
exports.mockerifyMessageMock = mockerifyMessageMock;
//# sourceMappingURL=message-mock.js.map