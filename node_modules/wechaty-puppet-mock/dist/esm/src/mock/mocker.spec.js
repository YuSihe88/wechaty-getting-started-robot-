...
import { ScanStatus, MessageType, FileBox, } from 'wechaty-puppet';
...
test.skip('MockContact.say(fileBox).to(contact)', async (t) => {
    ...
    const fileBox = FileBox.fromBase64('cRH9qeL3XyVnaXJkppBuH20tf5JlcG9uFX1lL2IvdHRRRS9kMMQxOPLKNYIzQQ==', 'mock-file.txt');
