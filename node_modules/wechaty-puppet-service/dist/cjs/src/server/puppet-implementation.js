...
const serialize_file_box_js_1 = require("./serialize-file-box.js");
function puppetImplementation(puppet) {
    ...
    const puppetServerImpl = {
        contactAlias: async (call, callback) => {
            wechaty_puppet_1.log.verbose('PuppetServiceImpl', 'contactAlias()');
        ...
        contactAvatar: async (call, callback) => {
            wechaty_puppet_1.log.verbose('PuppetServiceImpl', 'contactAvatar()');
            const id = call.request.getId();
            /**
             * Set
             */
        ...
        contactCorporationRemark: async (call, callback) => {
            wechaty_puppet_1.log.verbose('PuppetServiceImpl', 'contactCorporationRemark()');
        ...
        contactDescription: async (call, callback) => {
            wechaty_puppet_1.log.verbose('PuppetServiceImpl', 'contactDescription()');
            const contactId = call.request.getContactId();
        ...
        contactList: async (call, callback) => {
            wechaty_puppet_1.log.verbose('PuppetServiceImpl', 'contactList()');
        ...
        contactPayload: async (call, callback) => {
            wechaty_puppet_1.log.verbose('PuppetServiceImpl', 'contactPayload()');
            const id = call.request.getId();
            try {
        ...
        contactPhone: async (call, callback) => {
            wechaty_puppet_1.log.verbose('PuppetServiceImpl', 'contactPhone()');
            try {
                const contactId = call.request.getContactId();
        ...
        contactSelfName: async (call, callback) => {
            wechaty_puppet_1.log.verbose('PuppetServiceImpl', 'contactSelfName()');
            try {
        ...
        contactSelfSignature: async (call, callback) => {
            wechaty_puppet_1.log.verbose('PuppetServiceImpl', 'contactSelfSignature()');
            try {
        ...
        ding: async (call, callback) => {
            wechaty_puppet_1.log.verbose('PuppetServiceImpl', 'ding()');
            try {
        ...
        dirtyPayload: async (call, callback) => {
            wechaty_puppet_1.log.verbose('PuppetServiceImpl', 'dirtyPayload()');
            try {
                const id = call.request.getId();
                ...
                return (0, grpc_error_js_1.grpcError)('dirtyPayload', e, callback);
            }
        },
        /**
         *
         ...
         */
        event: (streamingCall) => {
            wechaty_puppet_1.log.verbose('PuppetServiceImpl', 'event()');
            if (eventStreamManager.busy()) {
                wechaty_puppet_1.log.error('PuppetServiceImpl', 'event() there is another event() call not end when receiving a new one.');
                const error = {
        ...
        friendshipAccept: async (call, callback) => {
            wechaty_puppet_1.log.verbose('PuppetServiceImpl', 'friendshipAccept()');
            try {
                const id = call.request.getId();
        ...
        friendshipAdd: async (call, callback) => {
            wechaty_puppet_1.log.verbose('PuppetServiceImpl', 'friendshipAdd()');
            try {
                const contactId = call.request.getContactId();
        ...
        friendshipPayload: async (call, callback) => {
            wechaty_puppet_1.log.verbose('PuppetServiceImpl', 'friendshipPayload()');
            try {
                const id = call.request.getId();
        ...
        friendshipSearchPhone: async (call, callback) => {
            wechaty_puppet_1.log.verbose('PuppetServiceImpl', 'friendshipSearchPhone()');
            try {
        ...
        friendshipSearchWeixin: async (call, callback) => {
            wechaty_puppet_1.log.verbose('PuppetServiceImpl', 'friendshipSearchWeixin()');
            try {
        ...
        logout: async (call, callback) => {
            wechaty_puppet_1.log.verbose('PuppetServiceImpl', 'logout()');
        ...
        messageContact: async (call, callback) => {
            wechaty_puppet_1.log.verbose('PuppetServiceImpl', 'messageContact()');
            try {
                const id = call.request.getId();
        ...
        messageFile: async (call, callback) => {
            wechaty_puppet_1.log.verbose('PuppetServiceImpl', 'messageFile()');
            try {
                const id = call.request.getId();
                const fileBox = await puppet.messageFile(id);
                const response = new wechaty_grpc_1.puppet.MessageFileResponse();
                response.setFilebox(await (0, serialize_file_box_js_1.serializeFileBox)(fileBox));
                return callback(null, response);
            }
            catch (e) {
        ...
        messageFileStream: async (call) => {
            wechaty_puppet_1.log.verbose('PuppetServiceImpl', 'messageFileStream()');
            try {
                const id = call.request.getId();
                const fileBox = await puppet.messageFile(id);
                ...
                wechaty_puppet_1.log.error('PuppetServiceImpl', 'grpcError() messageFileStream() rejection: %s', e && e.message);
                call.destroy(e);
            }
        },
        messageForward: async (call, callback) => {
            wechaty_puppet_1.log.verbose('PuppetServiceImpl', 'messageForward()');
            try {
        ...
        messageImage: async (call, callback) => {
            wechaty_puppet_1.log.verbose('PuppetServiceImpl', 'messageImage()');
            try {
                const id = call.request.getId();
                const type = call.request.getType();
        ...
        messageImageStream: async (call) => {
            wechaty_puppet_1.log.verbose('PuppetServiceImpl', 'messageImageStream()');
            try {
                const id = call.request.getId();
                const type = call.request.getType();
                const fileBox = await puppet.messageImage(id, type);
                ...
                wechaty_puppet_1.log.error('PuppetServiceImpl', 'grpcError() messageImageStream() rejection: %s', e && e.message);
                call.destroy(e);
            }
        },
        messageMiniProgram: async (call, callback) => {
            wechaty_puppet_1.log.verbose('PuppetServiceImpl', 'messageMiniProgram()');
            try {
                const id = call.request.getId();
        ...
        messagePayload: async (call, callback) => {
            wechaty_puppet_1.log.verbose('PuppetServiceImpl', 'messagePayload()');
            try {
                const id = call.request.getId();
        ...
        messageRecall: async (call, callback) => {
            wechaty_puppet_1.log.verbose('PuppetServiceImpl', 'messageRecall()');
            try {
                const id = call.request.getId();
        ...
        messageSendContact: async (call, callback) => {
            wechaty_puppet_1.log.verbose('PuppetServiceImpl', 'messageSendContact()');
            try {
                const conversationId = call.request.getConversationId();
                const contactId = call.request.getContactId();
        ...
        messageSendFile: async (call, callback) => {
            wechaty_puppet_1.log.verbose('PuppetServiceImpl', 'messageSendFile()');
            try {
                const conversationId = call.request.getConversationId();
        ...
        messageSendFileStream: async (call, callback) => {
            wechaty_puppet_1.log.verbose('PuppetServiceImpl', 'messageSendFileStream()');
            try {
        ...
        messageSendMiniProgram: async (call, callback) => {
            wechaty_puppet_1.log.verbose('PuppetServiceImpl', 'messageSendMiniProgram()');
            try {
                const conversationId = call.request.getConversationId();
        ...
        messageSendText: async (call, callback) => {
            wechaty_puppet_1.log.verbose('PuppetServiceImpl', 'messageSendText()');
            try {
                const conversationId = call.request.getConversationId();
        ...
        messageSendUrl: async (call, callback) => {
            wechaty_puppet_1.log.verbose('PuppetServiceImpl', 'messageSendUrl()');
            try {
                const conversationId = call.request.getConversationId();
        ...
        messageUrl: async (call, callback) => {
            wechaty_puppet_1.log.verbose('PuppetServiceImpl', 'messageUrl()');
            try {
                const id = call.request.getId();
        ...
        roomAdd: async (call, callback) => {
            wechaty_puppet_1.log.verbose('PuppetServiceImpl', 'roomAdd()');
            try {
        ...
        roomAnnounce: async (call, callback) => {
            wechaty_puppet_1.log.verbose('PuppetServiceImpl', 'roomAnnounce()');
            try {
                const roomId = call.request.getId();
                /**
                 * Set
        ...
        roomAvatar: async (call, callback) => {
            wechaty_puppet_1.log.verbose('PuppetServiceImpl', 'roomAvatar()');
            try {
                const roomId = call.request.getId();
        ...
        roomCreate: async (call, callback) => {
            wechaty_puppet_1.log.verbose('PuppetServiceImpl', 'roomCreate()');
            try {
        ...
        roomDel: async (call, callback) => {
            wechaty_puppet_1.log.verbose('PuppetServiceImpl', 'roomDel()');
            try {
                const roomId = call.request.getId();
                const contactId = call.request.getContactId();
        ...
        roomInvitationAccept: async (call, callback) => {
            wechaty_puppet_1.log.verbose('PuppetServiceImpl', 'roomInvitationAccept()');
            try {
                const id = call.request.getId();
        ...
        roomInvitationPayload: async (call, callback) => {
            wechaty_puppet_1.log.verbose('PuppetServiceImpl', 'roomInvitationPayload()');
            try {
        ...
        roomList: async (call, callback) => {
            wechaty_puppet_1.log.verbose('PuppetServiceImpl', 'roomList()');
            void call;
            try {
        ...
        roomMemberList: async (call, callback) => {
            wechaty_puppet_1.log.verbose('PuppetServiceImpl', 'roomMemberList()');
            try {
                const roomId = call.request.getId();
        ...
        roomMemberPayload: async (call, callback) => {
            wechaty_puppet_1.log.verbose('PuppetServiceImpl', 'roomMemberPayload()');
            try {
                const roomId = call.request.getId();
        ...
        roomPayload: async (call, callback) => {
            wechaty_puppet_1.log.verbose('PuppetServiceImpl', 'roomPayload()');
            try {
                const roomId = call.request.getId();
        ...
        roomQRCode: async (call, callback) => {
            wechaty_puppet_1.log.verbose('PuppetServiceImpl', 'roomQRCode()');
            try {
                const roomId = call.request.getId();
        ...
        roomQuit: async (call, callback) => {
            wechaty_puppet_1.log.verbose('PuppetServiceImpl', 'roomQuit()');
            try {
                const roomId = call.request.getId();
        ...
        roomTopic: async (call, callback) => {
            wechaty_puppet_1.log.verbose('PuppetServiceImpl', 'roomTopic()');
            try {
                const roomId = call.request.getId();
                /**
                 * Set
        ...
        start: async (call, callback) => {
            wechaty_puppet_1.log.verbose('PuppetServiceImpl', 'start()');
            void call;
            try {
                await puppet.start();
        ...
        stop: async (call, callback) => {
            wechaty_puppet_1.log.verbose('PuppetServiceImpl', 'stop()');
            void call;
            try {
                if (eventStreamManager.busy()) {
                    ...
                    wechaty_puppet_1.log.error('PuppetServiceImpl', 'stop() eventStreamManager is not busy?');
                }
                await puppet.stop();
                readyPayload = undefined;
        ...
        tagContactAdd: async (call, callback) => {
            wechaty_puppet_1.log.verbose('PuppetServiceImpl', 'tagContactAdd()');
            try {
        ...
        tagContactDelete: async (call, callback) => {
            wechaty_puppet_1.log.verbose('PuppetServiceImpl', 'tagContactDelete()');
            try {
                const tagId = call.request.getId();
        ...
        tagContactList: async (call, callback) => {
            wechaty_puppet_1.log.verbose('PuppetServiceImpl', 'tagContactList()');
            try {
        ...
        tagContactRemove: async (call, callback) => {
            wechaty_puppet_1.log.verbose('PuppetServiceImpl', 'tagContactRemove()');
            try {
                const tagId = call.request.getId();
                const contactId = call.request.getContactId();
        ...
        version: async (call, callback) => {
            wechaty_puppet_1.log.verbose('PuppetServiceImpl', 'version() v%s', puppet.version());
            void call;
            try {
