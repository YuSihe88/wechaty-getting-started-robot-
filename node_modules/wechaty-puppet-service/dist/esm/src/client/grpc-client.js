...
class GrpcClient extends EventEmitter {
    constructor(options) {
        ...
        log.verbose('GrpcClient', 'constructor() tlsRootCert(hash): "%s"', crypto.createHash('sha256')
            .update(this.caCert)
            .digest('hex'));
        /**
    ...
    async stop() {
         ...
         * 2. Stop the puppet
         */
        await util.promisify(this.client.stop.bind(this.client))(new puppet.StopRequest());
        /**
    ...
    async init() {
        ...
        this.client = new puppet.PuppetClient(this.endpoint, credential, clientOptions);
    }
    destroy() {
