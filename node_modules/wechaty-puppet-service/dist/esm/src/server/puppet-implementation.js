import { grpc, puppet as pbPuppet, StringValue, } from 'wechaty-grpc';
import { log, FileBox, FriendshipSceneType, } from 'wechaty-puppet';
import { packFileBoxToPb, unpackConversationIdFileBoxArgsFromPb, } from '../file-box-stream/mod.js';
    ...
    const puppetServerImpl = {
        ...
        contactAvatar: async (call, callback) => {
            ...
            try {
                ...
                if (fileBoxWrapper) {
                    const fileBox = FileBox.fromJSON(fileBoxWrapper.getValue());
