...
(0, tstest_1.test)('parseFriendConfirm()', async (t) => {
    const contentList = [
        [
    ...
    let result;
    const firer = new firer_js_1.Firer(mockPuppetWeChat);
...
(0, tstest_1.test)('parseRoomJoin()', async (t) => {
    const contentList = [
        [
...
(0, tstest_1.test)('parseRoomLeave()', async (t) => {
...
(0, tstest_1.test)('parseRoomTopic()', async (t) => {
    const contentList = [
        [
