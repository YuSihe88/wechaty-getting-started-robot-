...
(0, tstest_1.test)('PuppetWeChatFriendship.receive smoke testing', async (t) => {
...
(0, tstest_1.test)('PuppetWeChatFriendship.confirm smoke testing', async (t) => {
  ...
  `);
    ...
    t.equal(friendshipPayload2.type, wechaty_puppet_1.FriendshipType.Confirm, 'should be confirm type');
    sandbox.restore();
});
