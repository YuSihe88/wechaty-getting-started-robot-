...
import { ContactType, FriendshipType, Puppet, FileBox, throwUnsupportedError, ImageType, ScanStatus, log, } from 'wechaty-puppet';
import { qrCodeForChatie, retry, VERSION, } from './config.js';
...
export class PuppetWechat4u extends Puppet {
    constructor(options = {}) {
        ...
        this.cacheMessageRawPayload = new LRUCache(lruOptions);
    }
    async start() {
    ...
    async messageImage(messageId, imageType) {
        log.verbose('PuppetWechat4u', 'messageImage(%s, %s[%s])', messageId, imageType, ImageType[imageType]);
        return throwUnsupportedError();
    }
...
PuppetWechat4u.VERSION = VERSION;
