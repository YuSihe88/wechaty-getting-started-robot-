...
import { FileBox, MemoryCard } from './config.js';
...
import type { RoomMemberPayload, RoomMemberQueryFilter, RoomPayload, RoomPayloadFilterFunction, RoomQueryFilter } from './schemas/room.js';
...
import { PuppetOptions, YOU } from './schemas/puppet.js';
 ...
 *
 */
declare abstract class Puppet extends PuppetEventEmitter {
...
declare type PuppetImplementation = Constructor<Puppet>;
export type { PuppetImplementation, };
export { Puppet, };
