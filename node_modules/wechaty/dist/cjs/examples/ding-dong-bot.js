 ...
 *
 */
const mod_js_1 = require("../src/mod.js"); // from 'wechaty'
 ...
 *
 */
const bot = new mod_js_1.Wechaty({
    name: 'ding-dong-bot',
    /**
...
function onScan(qrcode, status) {
    if (status === mod_js_1.ScanStatus.Waiting || status === mod_js_1.ScanStatus.Timeout) {
        (0, qrcode_terminal_1.generate)(qrcode);
...
async function onMessage(msg) {
     ...
     */
    const fileBox = mod_js_1.FileBox.fromUrl('https://wechaty.github.io/wechaty/images/bot-qr-code.png');
