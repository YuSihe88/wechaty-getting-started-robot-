...
const open_graph_js_1 = require("../helper-functions/impure/open-graph.js");
...
class UrlLink {
    ...
    constructor(payload) {
        ...
        wechaty_puppet_1.log.verbose('UrlLink', 'constructor()');
        guard_wechatify_class_js_1.guardWechatifyClass.call(this, UrlLink);
    }
    ...
    static async create(url) {
        wechaty_puppet_1.log.verbose('UrlLink', 'create(%s)', url);
        const meta = await (0, open_graph_js_1.openGraph)(url);
        let description;
        let imageUrl;
        let title;
        if (meta.image) {
...
function wechatifyUrlLink(wechaty) {
    wechaty_puppet_1.log.verbose('UrlLink', 'wechatifyUrlLink(%s)', wechaty);
