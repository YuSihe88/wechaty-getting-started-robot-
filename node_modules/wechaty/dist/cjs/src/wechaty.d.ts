import { FileBox, MemoryCard, Puppet, PuppetOptions, StateSwitch } from 'wechaty-puppet';
import type { Sayable } from './types.js';
import type { PuppetModuleName } from './puppet-config.js';
import { Contact, ContactSelf, Friendship, Image, Message, MiniProgram, Room, RoomInvitation, Tag, UrlLink, Location } from './user/mod.js';
import { WechatyEventEmitter, WechatyEventName } from './events/wechaty-events.js';
...
declare class Wechaty extends WechatyEventEmitter implements Sayable {
    ...
    static readonly log: import("brolog").Brolog;
    readonly log: import("brolog").Brolog;
