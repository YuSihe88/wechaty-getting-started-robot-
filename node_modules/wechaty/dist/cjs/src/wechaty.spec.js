...
const wechaty_js_1 = require("./wechaty.js");
const mod_js_1 = require("./mod.js");
class WechatyTest extends wechaty_js_1.Wechaty {
    wechatifyUserModulesTest(puppet) {
        return this.wechatifyUserModules(puppet);
    }
}
(0, tstest_1.test)('Export of the Framework', async (t) => {
    t.ok(mod_js_1.Contact, 'should export Contact');
    t.ok(mod_js_1.Friendship, 'should export Friendship');
    t.ok(mod_js_1.IoClient, 'should export IoClient');
    t.ok(mod_js_1.Message, 'should export Message');
    t.ok(wechaty_puppet_1.Puppet, 'should export Puppet');
    t.ok(mod_js_1.Room, 'should export Room');
    t.ok(wechaty_js_1.Wechaty, 'should export Wechaty');
    t.ok(mod_js_1.log, 'should export log');
});
(0, tstest_1.test)('static VERSION', async (t) => {
    t.ok('VERSION' in wechaty_js_1.Wechaty, 'Wechaty should has a static VERSION property');
});
(0, tstest_1.test)('Config setting', async (t) => {
    t.ok(mod_js_1.config, 'should export Config');
    // t.ok(config.default.DEFAULT_PUPPET  , 'should has DEFAULT_PUPPET')
});
(0, tstest_1.test)('event:start/stop', async (t) => {
    const wechaty = new wechaty_js_1.Wechaty({ puppet: 'wechaty-puppet-mock' });
...
tstest_1.test.skip('SKIP DEALING WITH THE LISTENER EXCEPTIONS. on(event, Function)', async (t) => {
    ...
    const wechaty = wechaty_js_1.Wechaty.instance();
...
tstest_1.test.skip('SKIP DEALING WITH THE LISTENER EXCEPTIONS. test async error', async (t) => {
    ...
    class MyWechatyTest extends wechaty_js_1.Wechaty {
    }
...
(0, tstest_1.test)('initPuppetAccessory()', async (t) => {
...
(0, tstest_1.test)('Wechaty restart for many times', async (t) => {
    const wechaty = new wechaty_js_1.Wechaty({
        puppet: new wechaty_puppet_mock_1.PuppetMock(),
    });
    try {
        for (let i = 0; i < 3; i++) {
...
(0, tstest_1.test)('@event ready', async (t) => {
    const puppet = new wechaty_puppet_mock_1.PuppetMock();
    const wechaty = new wechaty_js_1.Wechaty({ puppet });
