...
import type { Acceptable } from '../types.js';
...
declare class Friendship extends EventEmitter implements Acceptable {
     ...
     *
     */
    static search(queryFilter: FriendshipSearchQueryFilter): Promise<null | Contact>;
    /**
     ...
     *
     */
    static add(contact: Contact, options: FriendshipAddOptions): Promise<void>;
