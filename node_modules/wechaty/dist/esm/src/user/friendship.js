...
import { FriendshipType, log, } from 'wechaty-puppet';
import { retryPolicy, } from '../helper-functions/mod.js';
 ...
 */
class Friendship extends EventEmitter {
    /*
     * @hideconstructor
     */
    constructor(id) {
    ...
    toString() {
        ...
        return [
            'Friendship#',
            FriendshipType[__classPrivateFieldGet(this, _Friendship_payload, "f").type],
            '<',
    ...
    async accept() {
        ...
        log.silly('Friendship', 'accept() to %s', __classPrivateFieldGet(this, _Friendship_payload, "f").contactId);
