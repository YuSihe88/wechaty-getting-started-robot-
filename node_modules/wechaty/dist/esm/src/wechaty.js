...
var _Wechaty_wechatifiedContact, _Wechaty_wechatifiedContactSelf, _Wechaty_wechatifiedFriendship, _Wechaty_wechatifiedImage, _Wechaty_wechatifiedMessage, _Wechaty_wechatifiedMiniProgram, _Wechaty_wechatifiedRoom, _Wechaty_wechatifiedRoomInvitation, _Wechaty_wechatifiedTag, _Wechaty_wechatifiedUrlLink, _Wechaty_wechatifiedLocation;
/**
...
import os from 'os';
import { log, MemoryCard, PayloadType, PUPPET_EVENT_DICT, StateSwitch, } from 'wechaty-puppet';
import { instanceToClass, } from 'clone-class';
import { captureException } from './raven.js';
import { config, VERSION, GIT_COMMIT_HASH, } from './config.js';
import { Io, } from './io.js';
import { PuppetManager, } from './puppet-manager.js';
import { wechatifyContact, wechatifyContactSelf, wechatifyFriendship, wechatifyImage, wechatifyMessage, wechatifyMiniProgram, wechatifyRoom, wechatifyRoomInvitation, wechatifyTag, wechatifyUrlLink, wechatifyLocation, } from './user/mod.js';
import { timestampToDate } from './helper-functions/pure/timestamp-to-date.js';
import { WechatyEventEmitter, } from './events/wechaty-events.js';
 ...
 * bot.start()
 */
class Wechaty extends WechatyEventEmitter {
    /**
    ...
    constructor(options = {}) {
        ...
        this.log = log;
        _Wechaty_wechatifiedContact.set(this, void 0);
        _Wechaty_wechatifiedContactSelf.set(this, void 0);
        _Wechaty_wechatifiedFriendship.set(this, void 0);
        _Wechaty_wechatifiedImage.set(this, void 0);
        _Wechaty_wechatifiedMessage.set(this, void 0);
        _Wechaty_wechatifiedMiniProgram.set(this, void 0);
        _Wechaty_wechatifiedRoom.set(this, void 0);
        _Wechaty_wechatifiedRoomInvitation.set(this, void 0);
        _Wechaty_wechatifiedTag.set(this, void 0);
        _Wechaty_wechatifiedUrlLink.set(this, void 0);
        _Wechaty_wechatifiedLocation.set(this, void 0);
    ...
    get Contact() { return guardWechatify(__classPrivateFieldGet(this, _Wechaty_wechatifiedContact, "f")); }
    get ContactSelf() { return guardWechatify(__classPrivateFieldGet(this, _Wechaty_wechatifiedContactSelf, "f")); }
    get Friendship() { return guardWechatify(__classPrivateFieldGet(this, _Wechaty_wechatifiedFriendship, "f")); }
    get Image() { return guardWechatify(__classPrivateFieldGet(this, _Wechaty_wechatifiedImage, "f")); }
    get Message() { return guardWechatify(__classPrivateFieldGet(this, _Wechaty_wechatifiedMessage, "f")); }
    get MiniProgram() { return guardWechatify(__classPrivateFieldGet(this, _Wechaty_wechatifiedMiniProgram, "f")); }
    get Room() { return guardWechatify(__classPrivateFieldGet(this, _Wechaty_wechatifiedRoom, "f")); }
    get RoomInvitation() { return guardWechatify(__classPrivateFieldGet(this, _Wechaty_wechatifiedRoomInvitation, "f")); }
    get Tag() { return guardWechatify(__classPrivateFieldGet(this, _Wechaty_wechatifiedTag, "f")); }
    get UrlLink() { return guardWechatify(__classPrivateFieldGet(this, _Wechaty_wechatifiedUrlLink, "f")); }
    get Location() { return guardWechatify(__classPrivateFieldGet(this, _Wechaty_wechatifiedLocation, "f")); }
    /**
    ...
    on(event, listener) {
        log.verbose('Wechaty', 'on(%s, listener) registering... listenerCount: %s', event, this.listenerCount(event));
    ...
    initPuppetEventBridge(puppet) {
        ...
        const eventNameList = Object.keys(PUPPET_EVENT_DICT);
        for (const eventName of eventNameList) {
            log.verbose('Wechaty', 'initPuppetEventBridge() puppet.on(%s) (listenerCount:%s) registering...', eventName, puppet.listenerCount(eventName));
            switch (eventName) {
                case 'dong':
    ...
    wechatifyUserModules(puppet) {
        ...
        if (__classPrivateFieldGet(this, _Wechaty_wechatifiedContactSelf, "f")) {
            throw new Error('can not be initialized twice!');
        }
        /**
         * 1. Setup Wechaty User Classes
         */
        __classPrivateFieldSet(this, _Wechaty_wechatifiedContact, wechatifyContact(this), "f");
        __classPrivateFieldSet(this, _Wechaty_wechatifiedContactSelf, wechatifyContactSelf(this), "f");
        __classPrivateFieldSet(this, _Wechaty_wechatifiedFriendship, wechatifyFriendship(this), "f");
        __classPrivateFieldSet(this, _Wechaty_wechatifiedImage, wechatifyImage(this), "f");
        __classPrivateFieldSet(this, _Wechaty_wechatifiedMessage, wechatifyMessage(this), "f");
        __classPrivateFieldSet(this, _Wechaty_wechatifiedMiniProgram, wechatifyMiniProgram(this), "f");
        __classPrivateFieldSet(this, _Wechaty_wechatifiedRoom, wechatifyRoom(this), "f");
        __classPrivateFieldSet(this, _Wechaty_wechatifiedRoomInvitation, wechatifyRoomInvitation(this), "f");
        __classPrivateFieldSet(this, _Wechaty_wechatifiedTag, wechatifyTag(this), "f");
        __classPrivateFieldSet(this, _Wechaty_wechatifiedUrlLink, wechatifyUrlLink(this), "f");
        __classPrivateFieldSet(this, _Wechaty_wechatifiedLocation, wechatifyLocation(this), "f");
        this.puppet = puppet;
    }
    /**
     ...
     */
    async start() {
        log.verbose('Wechaty', '<%s>(%s) start() v%s is starting...', this.options.puppet || config.systemPuppetName(), this.options.name || '', this.version());
     ...
     */
    async stop() {
        log.verbose('Wechaty', '<%s> stop() v%s is stopping ...', this.options.puppet || config.systemPuppetName(), this.version());
        /**
         * Uninstall Plugins
    ...
    memoryCheck(minMegabyte = 4) {
        ...
        log.silly('Wechaty', 'memoryCheck() free: %d MB, require: %d MB', freeMegabyte, minMegabyte);
     ...
     */
    reset(reason) {
        log.verbose('Wechaty', 'reset() with reason: %s, call stack: %s', reason || 'no reason', 
        ...
        this.puppet.stop()
             ...
             */
            setTimeout(() => this.reset(), Math.floor((10 + 10 * Math.random()) * 1000));
        });
    }
    unref() {
...
_Wechaty_wechatifiedContact = new WeakMap(), _Wechaty_wechatifiedContactSelf = new WeakMap(), _Wechaty_wechatifiedFriendship = new WeakMap(), _Wechaty_wechatifiedImage = new WeakMap(), _Wechaty_wechatifiedMessage = new WeakMap(), _Wechaty_wechatifiedMiniProgram = new WeakMap(), _Wechaty_wechatifiedRoom = new WeakMap(), _Wechaty_wechatifiedRoomInvitation = new WeakMap(), _Wechaty_wechatifiedTag = new WeakMap(), _Wechaty_wechatifiedUrlLink = new WeakMap(), _Wechaty_wechatifiedLocation = new WeakMap();
Wechaty.VERSION = VERSION;
Wechaty.log = log;
