...
tstest_1.test('on/off events emitting', async (t) => {
    const spyOn = tstest_1.sinon.spy();
    const spyOff = tstest_1.sinon.spy();
    const ss = new state_switch_js_1.StateSwitch();
