...
tstest_1.test('contactQueryFilterFunction()', async (t) => {
...
tstest_1.test('roomQueryFilterFunction()', async (t) => {
    const TEXT_REGEX = 'query by regex';
    const TEXT_TEXT = 'query by text';
    const PAYLOAD_LIST = [
        {
...
tstest_1.test('contactRoomList()', async (t) => {
    const puppet = new puppet_test_js_1.PuppetTest();
...
tstest_1.test('reset event throttle for reset()', async (t) => {
    const puppet = new puppet_test_js_1.PuppetTest({});
    const sandbox = tstest_1.sinon.createSandbox();
...
tstest_1.test('setMemory() memory without name', async (t) => {
    const puppet = new puppet_test_js_1.PuppetTest();
    const memory = new config_js_1.MemoryCard();
...
tstest_1.test('setMemory() memory with a name', async (t) => {
    const puppet = new puppet_test_js_1.PuppetTest();
...
tstest_1.test('messageQueryFilterFactory() one condition', async (t) => {
...
tstest_1.test('messageQueryFilterFactory() two condition', async (t) => {
